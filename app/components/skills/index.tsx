...
export function Skills({ title, description, icons }: { title: string, description: string, icons: IIcons[] }) {
    return (
        <div className="border-primary/10 border-0 shadow-none ">
...
const Skeleton = ({ icons }: { icons: IIcons[] }) => {
    const scale = [1, 1.1, 1];
    ...
    return (
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
            ...
            <div className="h-40 w-px absolute sm:top-10 m-auto z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
                <div className="w-10 h-32 sm:top-1/2 -translate-y-1/2 absolute -left-10">
                    <Sparkles />
                </div>
            </div>
        </div>
