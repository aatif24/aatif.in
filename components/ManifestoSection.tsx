...
import { Philosophy } from '@/lib/strapi';

interface ManifestoSectionProps {
    philosophies: Philosophy[];
}

export const ManifestoSection: React.FC<ManifestoSectionProps> = ({ philosophies }) => {
    return (
            ...
            <div className="w-full relative z-10">
                ...
                <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-start">
                    ...
                    <div className="md:col-span-7 space-y-10">
                        {philosophies && philosophies.length > 0 ? (
                            philosophies.map((philosophy, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-base text-muted-foreground font-light opacity-80 text-sm md:text-base">
                                        <span className="text-foreground font-medium">{philosophy.content}</span>
                                    </p>
                                </motion.div>
                            ))
                        ) : (
                            <>
                                {/* Default philosophies if none from CMS */}
