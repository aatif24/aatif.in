...
export const Footer: React.FC = () => {
    return (
        <footer className="border-t snap-start border-border mt-12 py-8 px-4 md:px-6 relative overflow-hidden">
            {/* Geometric accents */}
            <div className="hidden md:block absolute top-4 left-12 w-12 h-12 border border-primary/30" />
            <div className="hidden md:block absolute bottom-4 right-12 w-8 h-8 rounded-full bg-primary" />
